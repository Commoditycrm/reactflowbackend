...
export class Neo4JConnection {
  ...
  private neo4jUri = EnvLoader.getOrThrow("NEO4J_URI");
  private neo4jUser = EnvLoader.getOrThrow("NEO4J_USERNAME");
  private neo4jPassword = EnvLoader.getOrThrow("NEO4J_PASSWORD");
